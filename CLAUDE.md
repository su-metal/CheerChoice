...
`CLAUDE.md` は CheerChoice の北極星ドキュメントです。
...
- `CLAUDE.md` は北極星として短く保つ。詳細仕様を増やしすぎない
- 機能追加、仕様変更、運用方針変更が発生したら、必要に応じて `CLAUDE.md` を更新する
- 要件整理、仕様確認、実装判断では `docs/requirements_definition.md` を参照する
- `CLAUDE.md` と `docs/requirements_definition.md` に差分が出る変更は、同じ作業内で両方を更新して整合を保つ
- 作業固有の変更は `.steering/[task]/requirements.md` と `.steering/[task]/design.md` に整理する

### Role Split
- `CLAUDE.md`: 現状、原則、制約、運用ルールの要約
...
## Last Updated
2026-03-24 - CLAUDE.md を北極星向けに簡潔化し、詳細仕様は requirements_definition.md を正本化
