...
- 本ファイル `docs/requirements_definition.md` は、CheerChoice の要件整理・仕様確認・実装判断に使う正本ドキュメントです
- `AGENTS.md` はプロジェクト現状の北極星ドキュメントとして運用し、本ファイルと整合した状態を保ちます
- 機能追加、仕様変更、運用方針変更が発生した場合は、`AGENTS.md` と本ファイルを同じ作業内で更新します
- 北極星として常時読む情報は `AGENTS.md` に寄せ、本ファイルには詳細仕様、背景、受け入れ条件を保持します
...
#### 無料プラン
- AI写真分析: **7回（lifetime上限）** → 1ユーザーあたり最大$0.021の取得コスト
...
- 無料ユーザー: 最大$0.021/人（一回限り）→ 月額ランニングコスト$0
